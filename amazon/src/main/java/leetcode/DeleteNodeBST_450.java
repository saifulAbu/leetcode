...
public class DeleteNodeBST_450 {
  ...
  public z_trash.TreeNode deleteNode(z_trash.TreeNode curNode, int key) {
    if(curNode == null) {
      return null;
    }
    ...
    z_trash.TreeNode left = curNode.left, right = curNode.right;
  ...
  private z_trash.TreeNode deleteTargetNodeWithTwoChild(z_trash.TreeNode targetNode) {
    z_trash.TreeNode left = targetNode.left, right = targetNode.right, newRoot;
